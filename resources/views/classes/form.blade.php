...
<!-- page content -->
	  ...
	  <div class="row">
		<div class="col-md-12 col-sm-12  ">
		  ...
		  <div class="buttons">
									  <!-- Standard button -->
							  <a  id="printbtn" class="btn btn-success btn-sm" href="{{route('classes.index')}}"><i class="fa fa-bars"></i>List</a>
							  </div>
						
      <form  id="form" class="form-sample" method="POST" action="{{route('classes.store')}}">
        @csrf
